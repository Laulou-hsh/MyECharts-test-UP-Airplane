...
(function(){
    ...
    //1.实例化
    var myChart = echarts.init(document.querySelector(".barRightTop .chart"));
    //2.指定配置项和数据
    var option = {
        grid: {
            left: '20%',
...
(function(){
    ...
    var option = {
        ...
        legend: {
            //如果series 对象有name 值，则Legend可以不用写data
...
(function(){
    //1.实例化
    var myChart = echarts.init(document.querySelector(".rightLine .chart"));
    //2.置顶配置
    var option = {
        tooltip: {
            trigger: 'axis',
...
(function(){
    ...
    var GZData = [
    	...
    	[{name:'广州'}, {name:'成都',value:100}],
    	[{name:'广州'}, {name:'拉萨',value:100}],
        [{name:'广州'}, {name:'昆明',value:100}],
